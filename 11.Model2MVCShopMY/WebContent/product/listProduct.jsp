			 ...
			 $.ajax( 
						{
							...
							success : function(JSONData , status) {
								...
								var displayValue = "<h5>"
															...
															+"추가설명: "+JSONData.prodDetail+"<br/>"
															+"<img src=/images/uploadFiles/"+JSONData.fileName+" width="+"250><br/>" 
															+"</h5>";
								//Debug...									
								//alert(displayValue);
								$("h5").remove();
   				...
   				<form class="form-inline" name="detailForm">
   					...
   					<div class="form-group">
   						<select class="form-control" name="searchCondition">
   							...
   							<option value="2" ${! empty search.searchCondition && search.searchCondition==1 ? "selected" : "" }>가격</option>
   						</select>
   					</div>
   					...
   					<tr class="ct_list_pop">
	   					...
	   					<c:if test="${product.proTranCode == '1  '}">
	   						<td align="left">
	   							...
	   							<c:if test="${param.menu=='manage' }">
	   								배송하기
	   								<span style="display: none" class="hidden_link">/purchase/updateTranCodeByProd?prodNo=${product.prodNo }</span>
	   							</c:if>
	   						</td>
	   					</c:if>
	   					<c:if test="${product.proTranCode == '2  '}">
	   						<td align="left">
	   							배송중
	   							<span style="display: none" class="hidden_link">/purchase/updateTranCode?tranNo=${purchase.tranNo }</span>
	   						</td>
	   					</c:if>
