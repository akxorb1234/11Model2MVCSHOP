...
public class PurchaseController {
	...
	public ModelAndView addPurchaseView(@RequestParam("prodNo") int prodNo, HttpSession session) throws Exception {
		...
		System.out.println("/purchase/addPurchaseView 오냐?");
	...
	public ModelAndView addPurchase( @ModelAttribute("purchase") Purchase purchase,HttpSession session, @RequestParam("prodNo")int prodNo  ) throws Exception {
		...
		System.out.println("/purchase/addPurchase 온다");
	...
	public ModelAndView getPurchase( @RequestParam("tranNo") int tranNo) throws Exception {
		...
		System.out.println("/purchase/getPurchase 오냐");
	...
	public ModelAndView updateTranCodeByProd( @ModelAttribute("product") Product product  ) throws Exception{
		...
		System.out.println("여기나옴? : " + purchase);
